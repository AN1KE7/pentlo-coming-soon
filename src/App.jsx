...
function App() {
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center p-4 sm:p-8 lg:p-12 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16 xl:gap-24">
        
        {/* Left Side - Pentlo Builder Content */}
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left gap-8 flex-1">
          ...
          >
            ...
            <img
              ...
              className="relative z-10 w-64 sm:w-72 md:w-80 lg:w-[360px] xl:w-[420px] h-auto drop-shadow-2xl"
            />
          </motion.div>
